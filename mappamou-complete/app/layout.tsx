      ...
      <body>
        <div className="container py-6">
          <header className="flex items-center justify-between mb-6">
            <a className="text-xl font-bold" href="/">Mappamou</a>
            <nav className="flex items-center gap-3 text-sm">
              <a href="/lists/portugal-beaches">Lists</a>
              <a href="/map">My Map</a>
              <a href="/feed">Feed</a>
              <a className="badge" href="/u/mitsos">@mitsos</a>
            </nav>
          </header>
          ...
          <footer className="mt-10 text-xs opacity-70">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div>© {new Date().getFullYear()} Mappamou • Map data © OpenStreetMap contributors</div>
              <nav className="flex flex-wrap items-center gap-x-3 gap-y-2 not-prose">
                <a href="/countries" className="no-underline hover:underline">Countries</a>
                ...
                <a href="/cookies" className="no-underline hover:underline">Cookies</a>
                <a href="/licensing" className="no-underline hover:underline">Licensing</a>
                <a href="/contact" className="no-underline hover:underline">Contact</a>
                <a href="/report" className="no-underline hover:underline">Report</a>
              </nav>
            </div>
          </footer>
        </div>
